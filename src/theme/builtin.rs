//! Built-in Herdr palettes, ported verbatim from Herdr v0.9.1
//! (`src/app/state.rs`, `impl Palette`). Herdr is Apache-2.0 licensed.
//! Regenerate when Herdr adds or retunes a theme.
